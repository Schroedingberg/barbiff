(ns com.barbiff
  (:require [com.biffweb :as biff]
            [com.barbiff.email :as email]
            [com.barbiff.app :as app]
            [com.barbiff.home :as home]
            [com.barbiff.middleware :as mid]
            [com.barbiff.ui :as ui]
            [com.barbiff.worker :as worker]
            [com.barbiff.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.barbiff.*-test"))
